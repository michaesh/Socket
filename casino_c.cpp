...
#define MYPORT 10078
#define MYPORT2 11078
#define CASINOD 12078
#define CASINOB 9078
...
reads stop_ txt, store the number into message[] in <,,,>C form
*/
...
int main()
{
    ...
    cout<<"Casino C Phase 1: The casino C has dynamic TCP port number "<<ntohs(tcp.sin_port)<<" and IP address "<<s<<endl;
    cout<<"Casino C Phase 1: Sending the casino vector "<<message<<" to the transit hub"<<endl;

    cout<<"Casino C Phase 1: End of Phase 1\n";       
    ...
    socklen_t n;
    int len;
    char b1[100]; //Char array receiving
    char b2[100];//Char array to send
    ...
    cout<<"Casino C Phase 2: The casino C has static UDP port number "<<server.sin_port<<endl;
    cout<<"Casino C Phase 2: Received the train vector "<<b1<<" from casino B\n";
    int received[4];
    ...
    myStation[2]=received[2];
    received[2]=0;
    InttoString(b2,sizeof(b2),received);
    
    sock=socket(AF_INET,SOCK_DGRAM,0);
    server.sin_family=AF_INET;
    server.sin_port=CASINOD;
    server.sin_addr.s_addr=inet_addr("nunki.usc.edu");
    n=sizeof(server);
    ...
    cout<<"Casino C Phase 2: The casino C has dynamic UDP port number "<<ntohs(temp.sin_port)<<endl;
    cout<<"Casino C Phase 2: Sending the updated train vector "<<b2<<" to casino D\n";
    cout<<"Casino C Phase 2: The updated casino vector at C is ";
    char StationS[100];
    InttoString(StationS,sizeof(StationS),myStation);
    cout<<StationS<<endl;    
    cout<<"Casino C Phase 2: End of Phase 2\n";
    ...
    cout<<"Casino C Phase 3: The casino C has static UDP port number "<<server.sin_port<<endl;
    cout<<"Casino C Phase 3: Received the train vector "<<b1<<" from Casino D\n";
    ...
    getsockname(sock, (struct sockaddr *)&temp, (socklen_t*)&len);
    cout<<"Casino C Phase 2: The casino C has dynamic UDP port number "<<ntohs(temp.sin_port)<<endl;
    cout<<"Casino C Phase 2: Sending the updated train vector "<<b3<<" to casino B\n";
    cout<<"Casino C Phase 2: The updated casino vector at C is ";
    InttoString(StationS,sizeof(StationS),myStation);
    cout<<StationS<<endl;    
    cout<<"Casino C Phase 2: End of Phase 2\n";
